...
void MicroNano::acceptNasicEvent(EventNasic &obj, vector<boost::numeric::ublas::matrix<class NasicSimulationMatrixInfo*> > &m){
...
void MicroNano::setBlockWidth(int w){
    m_blockWidth = w;
}

int MicroNano::getBlockWidth(void){
    return m_blockWidth;
}

void MicroNano::setBlockHeight(int h){
    m_blockHeight = h;
}

int MicroNano::getBlockHeight(void){
    return m_blockHeight;
}


QString MicroNano::getBlockCode(void){
    return m_blockCode;
}

QString MicroNano::getBlockName(void){
    return m_blockName;
}
