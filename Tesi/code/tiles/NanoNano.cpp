...
void NanoNano::acceptNasicEvent(EventNasic &obj, vector<boost::numeric::ublas::matrix<class NasicSimulationMatrixInfo*> > &m){
...
void NanoNano::setBlockWidth(int w){
    m_blockWidth = w;
}

int NanoNano::getBlockWidth(void){
    return m_blockWidth;
}

void NanoNano::setBlockHeight(int h){
    m_blockHeight = h;
}

int NanoNano::getBlockHeight(void){
    return m_blockHeight;
}


QString NanoNano::getBlockCode(void){
    return m_blockCode;
}

QString NanoNano::getBlockName(void){
    return m_blockName;
}
